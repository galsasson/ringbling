function ParametricApp() {
    ...
    function addGui()
    {
        ...
        gui.add(ring, 'angle', 0, 180).onChange(function() {ring.updateGeometry(ring)});
        ...
        ringG.add(ring.ringr, 'width', 4, 30).onChange(function() {ring.updateGeometry(ring)});
        ringG.add(ring.ringr, 'height', 4, 30).onChange(function() {ring.updateGeometry(ring)});
        ...
        ringGL.add(ring.ringl, 'width', 4, 30).onChange(function() {ring.updateGeometry(ring)});
        ringGL.add(ring.ringl, 'height', 4, 30).onChange(function() {ring.updateGeometry(ring)});
