function ParametricApp() {
    ...
    function addGui()
    {
        ...
        ringG.add(ring.ringr.extra, 'flattenX', 0, 1).onChange(function() {ring.updateGeometry(ring)});
        ...
        ringGL.add(ring.ringl.extra, 'flattenX', 0, 1).onChange(function() {ring.updateGeometry(ring)});
